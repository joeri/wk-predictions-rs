-- Not sure that this really belongs in a migration, in that if we update the
-- definition it becomes a mess to search for the latest definition.
-- But it's the easiest method right now
CREATE OR REPLACE VIEW full_match_infos
AS SELECT
